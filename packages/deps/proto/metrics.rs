...
pub struct AddMetricResponse {
    ...
    pub http_metrics: ::core::option::Option<HttpMetrics>,
    #[prost(message, optional, tag = "4")]
    pub performance_metrics: ::core::option::Option<PerformanceMetrics>,
    #[prost(message, optional, tag = "5")]
    pub seo_metrics: ::core::option::Option<SeoMetrics>,
    #[prost(string, tag = "6")]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/metrics.Metrics/AddMetric",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("metrics.Metrics", "AddMetric"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/metrics.Metrics/AddMetric" => {
                    ...
                    struct AddMetricSvc<T: Metrics>(pub Arc<T>);
                    impl<T: Metrics> tonic::server::UnaryService<super::AddMetricRequest>
                    for AddMetricSvc<T> {
                        type Response = super::AddMetricResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Metrics>::add_metric(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
